...
SELECT pg_catalog.setval('categories_tasks_id_seq', 17, true);
...
COPY tasks (id, description, iscomplete, duedate) FROM stdin;
\.
...
SELECT pg_catalog.setval('tasks_id_seq', 35, true);
